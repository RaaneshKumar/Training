...
namespace Training {
   ...
   internal class Program {
      ...
      static void Main () {
         ...
         for (int i = 0; i < 10; i++) {
            switch (i) {
               case 0: PrintHLines ("\u250C", "\u252C", "\u2510"); break;
               case 1: PrintPieces ("\u265C", "\u265E", "\u265D", "\u265B", "\u265A"); break;
               case 2 or 4 or 7: PrintHLines ("\u251C", "\u253C", "\u2524"); break;
               case 3: PrintPawnsOrSpaces ("\u265F"); break;
               case 5:
                  for (int j = 0; j < 4; j++) {
                     PrintPawnsOrSpaces (" ");
                     PrintHLines ("\u251C", "\u253C", "\u2524");
                  ...
                  break;
               case 6: PrintPawnsOrSpaces ("\u2659"); break;
               case 8: PrintPieces ("\u2656", "\u2658", "\u2657", "\u2655", "\u2654"); break;
               case 9: PrintHLines ("\u2514", "\u2534", "\u2518"); break;
            }
         }
      }
      ...
      static void PrintHLines (string start, string mid, string end)
         => WriteLine ($"{start}" + string.Concat (Enumerable.Repeat ($"{sHLine}{sHLine}{sHLine}{mid}", 7))
                                                                    + $"{sHLine}{sHLine}{sHLine}{end}");
      ...
      static void PrintPieces (string rook, string knight, string bishop, string queen, string king)
         => WriteLine ($"{sVLine} {rook} {sVLine} {knight} {sVLine} {bishop} {sVLine} {queen} " +
                       $"{sVLine} {king} {sVLine} {bishop} {sVLine} {knight} {sVLine} {rook} {sVLine}");

      /// <summary>Prints black and white pawns or empty spaces</summary>
      /// <param name="pawn"></param>
      static void PrintPawnsOrSpaces (string pawn)
         => WriteLine (string.Concat (Enumerable.Repeat ($"{sVLine} {pawn} ", 8)) + $"{sVLine}");
      #endregion

      #region Private -----------------------------------------------
      static string sVLine = "\u2502", sHLine = "\u2500";
      #endregion
   }
   #endregion
}